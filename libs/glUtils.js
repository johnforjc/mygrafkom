(function(global) {
  var glUtils = {
    ...
    createProgram: function(gl, vertexShader, fragmentShader) {
      ...
      // cara cek apakah benar file shader
      console.log(gl.isShader(vertexShader));
      console.log(gl.isShader(fragmentShader));
      ...
      // cara cek shader apa saja yang sudah diattach di program
      console.log(gl.getAttachedShaders(program));
      var shader = gl.getAttachedShaders(program);
      for(var i=0; i<shader.length; i++)
      {
        console.log(gl.getShaderSource(shader[i]));
      }
